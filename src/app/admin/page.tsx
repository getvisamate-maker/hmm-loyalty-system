...
export default async function AdminDashboard() {
  ...
  const [
    ...
    adminDb.from("profiles").select("*", { count: "exact" }).order("created_at", { ascending: false }).limit(50),
    ...
    adminDb
      .from("profiles")
      .select("*")
      .not("requested_role", "is", null) // Fetch pending partners
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-xs font-medium text-zinc-500">
             ...
             <div className="flex items-center gap-3 ml-2 border-l border-zinc-800 pl-4">
                <Link href="/" className="text-zinc-400 hover:text-white transition-colors flex items-center gap-1" title="Back to Home">
